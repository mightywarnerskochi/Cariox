...
<section class="inner-banner services-banner">
    <div class="container-ctn w-100">
        <div class="content ">
            <h1 class="title">Terms and Conditoins</h1>
...
<section class="policy">
    <svg xmlns="http://www.w3.org/2000/svg" width="249" height="527" viewBox="0 0 249 527" fill="none">
        <path
            d="M248.192 525.882C168.104 525.882 96.7521 487.631 51.4508 428.409C19.4888 386.649 0.499995 334.47 0.499995 277.918V0.5H111.164V277.944C111.164 353.582 172.629 415.135 248.192 415.135"
            stroke="url(#paint0_linear_923_1042)" stroke-miterlimit="10" />
        <defs>
            <linearGradient id="paint0_linear_923_1042" x1="248.192" y1="263.204" x2="-0.833958" y2="263.204"
        ...
        <div class="container-ctn">
            <ul>
                ...
                <li>
                    ...
                    <p><strong>5.1</strong> Lorem Ipsum is simply dummy text of the printing and industry. Lorem Ipsum
                        has
                        been the industry's standard dummy text.</p>
                    <p><strong>5.2</strong> Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                        Lorem
                        Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer
                        took
                        a galley of type and scrambled it to make a type specimen book.</p>
                    <p><strong>5.3</strong> Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                        Lorem
                        Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer
                        took
                        a galley of type and scrambled it to make a type specimen book.</p>
                ...
                <li>
                    ...
                    <p>Lorem Ipsum is simply dummy text of the printing and industry. Lorem Ipsum has been the
                        industry's
                ...
                <li>
                    ...
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Please contact us at
                        <a href="mailto:info@cariox.ae">info@cariox.ae</a>.
                    </p>
                </li>
            </ul>
        </div>
