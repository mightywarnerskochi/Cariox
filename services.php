<?php
$page_title = 'Services | Cariox';
$page_desc = '';
include __DIR__ . '/includes/header.php';
?>
<div class="inner-vector">
    <picture><img src="public/images/inner/inner-vector.png" alt="Services"></picture>
</div>
...
<!-- Services Section -->
<section class="services-page-main commonPadding-120">
    <div class="container-ctn">
        <div class="services-header d-flex flex-wrap justify-content-between align-items-start mb-5">
        ...
        <div class="services-grid-layout">
            <div class="grid-left-col">
                <!-- Service 01: Supply -->
                <div class="service-detail-card card-supply">
                    <div class="text-content">
                        <h3>Supply</h3>
                        <p>Cariox is a leading name engaged in the trade of products and solutions to help clients
                            fulfill their needs across Middle East. The products we deal with includes a comprehensive
                            range of inkjet and laser printers, thermal transfer printers, food inspection systems, and
                            packing systems of famous brands. We not just involve in only sales, but helps customers
                            from installation of systems to providing post-sales support too.</p>
                    </div>
                ...
                <div class="service-detail-card card-installation">
                    <div class="text-content">
                        <h3>Installation</h3>
                        <p>Cariox understand how important the delivery and installation of products are to your
                            schedules and work activities. Our installation service don't just start when the product is
                            delivered. We plan the installation that properly aligns to your needs and ensure it works
                            properly as instructed by the manufacturer. Our job doesn't stop simply with installation,
                            we make certain your people are properly trained, follow up to make certain you are
                            fulfilled and make any necessary changes. We offer post-sales support as well to our
                            esteemed clients.</p>
                    </div>
            ...
            <div class="grid-right-col">
                <!-- Service 03: Annual Maintenance -->
                <div class="service-detail-card card-amc">
                    <div class="text-content">
                        <h3>Annual Maintenance</h3>
                        <p>We offer annual maintenance contract to all our equipment ensuring our customers great peace
                            of mind and to minimize the production downtime. The AMC customers are privileged with quick
                            response time, 24 hours telephone support, and special discounts on spare parts. If you want
                            to enhance your productivity then opting for the Annual Maintenance Contract service from
                            Cariox is definitely the way out.</p>
                    </div>
                ...
                <div class="contact-now-card">
                    ...
                    <div class="contact-methods">
                        <div class="method-item phone">
                            <span class="val">+971 6 749 4981</span>
                            <a href="tel:+97167494981" class="method-btn">Call Us Now</a>
                        </div>
                        <div class="method-item email">
                            <span class="val">info@cariox.com</span>
                            <a href="mailto:info@cariox.com" class="method-btn">Email Us</a>
                        </div>
                    </div>
                    <div class="whatsapp-wrapper">
                        <a href="https://wa.me/97167494981" class="btn btn-gradient">
