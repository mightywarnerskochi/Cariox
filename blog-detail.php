<?php
$page_title = 'Blog Detail | Cariox';
$page_desc = '';
include __DIR__ . '/includes/header.php';
?>
<div class="inner-vector">
    <picture><img src="public/images/inner/inner-vector.png" alt="Blogs"></picture>
</div>
        ...
        <div class="content ">
            ...
            <nav class="breadcrumb" aria-label="Breadcrumb">
                ...
                <span>
                    ...
                    Introduction to Industrial Inkjet Printing and...
                </span>
            </nav>
        </div>
    </div>
...
<section class="blog-detail-page commonPadding-120">
    <div class="container-ctn">
        <div class="blog-header-content text-center">
            <h1 class="blog-title">Introduction to Industrial Inkjet Printing and Inkjet Printers</h1>
            <div class="meta-info">
                <div class="meta-item author-pill">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M15.7105 12.7096C16.6909 11.9383 17.4065 10.8806 17.7577 9.68358C18.109 8.4866 18.0784 7.2099 17.6703 6.0311C17.2621 4.85231 16.4967 3.83003 15.4806 3.10649C14.4644 2.38296 13.2479 1.99414 12.0005 1.99414C10.753 1.99414 9.5366 2.38296 8.52041 3.10649C7.50423 3.83003 6.73883 4.85231 6.3307 6.0311C5.92256 7.2099 5.892 8.4866 6.24325 9.68358C6.59449 10.8806 7.31009 11.9383 8.29048 12.7096C6.61056 13.3827 5.14477 14.499 4.04938 15.9396C2.95398 17.3801 2.27005 19.0909 2.07048 20.8896C2.05604 21.021 2.0676 21.1538 2.10451 21.2807C2.14142 21.4075 2.20295 21.5259 2.2856 21.629C2.4525 21.8371 2.69527 21.9705 2.96048 21.9996C3.2257 22.0288 3.49164 21.9514 3.69981 21.7845C3.90798 21.6176 4.04131 21.3749 4.07048 21.1096C4.29007 19.1548 5.22217 17.3494 6.6887 16.0384C8.15524 14.7274 10.0534 14.0027 12.0205 14.0027C13.9876 14.0027 15.8857 14.7274 17.3523 16.0384C18.8188 17.3494 19.7509 19.1548 19.9705 21.1096C19.9977 21.3554 20.1149 21.5823 20.2996 21.7466C20.4843 21.911 20.7233 22.0011 20.9705 21.9996H21.0805C21.3426 21.9695 21.5822 21.8369 21.747 21.6309C21.9119 21.4248 21.9886 21.162 21.9605 20.8996C21.76 19.0958 21.0724 17.3806 19.9713 15.9378C18.8703 14.4951 17.3974 13.3791 15.7105 12.7096ZM12.0005 11.9996C11.2094 11.9996 10.436 11.765 9.7782 11.3255C9.12041 10.886 8.60772 10.2613 8.30497 9.53037C8.00222 8.79947 7.923 7.9952 8.07734 7.21927C8.23168 6.44335 8.61265 5.73062 9.17206 5.17121C9.73147 4.6118 10.4442 4.23084 11.2201 4.0765C11.996 3.92215 12.8003 4.00137 13.5312 4.30412C14.2621 4.60687 14.8868 5.11956 15.3264 5.77735C15.7659 6.43515 16.0005 7.20851 16.0005 7.99964C16.0005 9.0605 15.5791 10.0779 14.8289 10.8281C14.0788 11.5782 13.0613 11.9996 12.0005 11.9996Z" fill="#FF9700"/>
                    </svg>
                    <span>Post By : Admin</span>
                </div>
                <!-- no border left here, specific styling for pills -->
                <div class="meta-item date-pill">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="5" width="16" height="15" rx="2" stroke="#8747E2" stroke-width="1.5"/><path d="M16 3V7M8 3V7M4 10H20" stroke="#8747E2" stroke-width="1.5" stroke-linecap="round"/></svg>
                    <span>01 Jul, 2019</span>
                </div>
            </div>
        </div>
        <div class="blog-featured-img">
            <img src="public/images/blogs/1.jpg" alt="INDUSTRIAL INKJET PRINTER" class="img-fluid w-100">
        </div>
        ...
        <div class="blog-detail-layout">
            ...
            <div class="sidebar-column">
                <div class="sidebar-widget new-articles-widget">
                    <h4 class="widget-title">New Articles</h4>
                    <div class="sidebar-article-list">
                        <?php
$articles = [
    ['title' => 'What is a Handjet EBS 260 Printer?', 'img' => '2.jpg'],
    ['title' => 'Don\'t Forget the Following Potential Factors When Buying a Continuous Inkjet Printer in 2021', 'img' => '4.jpg'],
    ['title' => 'HOW TO CHOOSE AN IMPORTANT X-RAY MACHINE FOR FOOD PROCESSING?', 'img' => '5.jpg'],
    ['title' => 'Why x-ray changes are needed matters for your packaging too?', 'img' => '7.jpg']
];
foreach ($articles as $article): ?>
                        <a href="blog-detail.php" class="article-item">
                            <div class="img-wrapper">
                                <img src="public/images/blogs/<?php echo $article['img']; ?>" alt="Article Image">
                            </div>
                            <div class="content">
                                <h5><?php echo $article['title']; ?></h5>
                                <span class="corner-arrow">
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1 11L11 1M11 1H3M11 1V9" stroke="#111" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </span>
                            </div>
                        </a>
