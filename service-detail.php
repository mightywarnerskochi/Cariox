        ...
        <div class="service-detail-grid ">
            <aside class="service-sidebar">
                <div class="sidebar-box">
                    ...
                    <form class="sidebar-enquire-form">
                        <div class="formGroup">
                        ...
                        <div class="formGroup">
                            <input type="tel" placeholder="+971 Phone" class="form-control phone_number">
                        </div>
                        <div class="formGroup">
            ...
            <main class="service-main features-list">
                <picture>
                    <img src="public/images/services/blog.jpg" alt="Installation Work" width="1080" height="480"
                        class="img-fluid">
                </picture>


                <div class="service-text-content ">
                    <p>Cariox Gulf LLC understand how important the delivery and installation of products are to your
                        ...
                        properly as instructed by the manufacturer. Our job doesn't stop simply with installation, we
                        make certain your people are properly trained, follow up to make certain you are fulfilled and
                        make any necessary changes. We offer post-sales support as well to our esteemed clients.</p>
                ...
                <div class="service-gallery ">
                    <div class="gallery-item">
                        <img src="public/images/services/blog-2.jpg" alt="Setup Stage 1">
                    </div>
                    <div class="gallery-item">
                        <img src="public/images/services/blog.jpg" alt="Setup Stage 2">
                    </div>
                </div>
