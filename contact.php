        ...
        <div class="contact-page__layout d-flex flex-wrap">
            ...
            <article class="contact-page__info-panel">
                <div class="contact-info-card">
                    ...
                    <div class="contact-info-card__grid">
                        <div class="contact-info-card__action">
                            <a href="tel:+97167494981" class="contact-info-card__value">+971 6 749 4981</a>
                            <a href="tel:+97167494981" class="contact-info-card__button">Call Us Now</a>
                        </div>
                        <div class="contact-info-card__action">
                            <a href="mailto:info@cariox.com" class="contact-info-card__value">info@cariox.com</a>
                            <a href="mailto:info@cariox.com" class="contact-info-card__button">Email Us</a>
                        </div>
                        <div class="contact-info-card__action">
                            <a href="tel:+97167494981" class="contact-info-card__value">+971 6 749 4981</a>
                            <a href="tel:+97167494981" class="contact-info-card__button">Call Us Now</a>
                    ...
                    <div class="contact-info-card__footer">
                        <div class="contact-info-card__country">
                                                            <img src="public/images/flag/uae.png" width="50" height="50" alt="United Arab Emirates Flag" class="contact-info-card__flag contact-info-card__flag-uae">

                            <span>United Arab Emirates</span>
                        </div>
                        <div class="contact-info-card__links">
                            <a href="https://wa.me/+971545864310?text=Can%20I%20get%20more%20details%20about%20your%20service?" target="_blank" rel="noopener" class="contact-info-card__whatsapp">
                            ...
                            <a href="#" class="contact-info-card__map">View Map</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-info-card">
                    <div class="contact-info-card__top">
                        <div class="contact-info-card__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                <path d="M14 15.1667C15.933 15.1667 17.5 13.5997 17.5 11.6667C17.5 9.73367 15.933 8.16666 14 8.16666C12.067 8.16666 10.5 9.73367 10.5 11.6667C10.5 13.5997 12.067 15.1667 14 15.1667Z" stroke="#111827" stroke-width="1.8"/>
                                <path d="M23.3333 11.6667C23.3333 18.6667 14 24.5 14 24.5C14 24.5 4.66666 18.6667 4.66666 11.6667C4.66666 9.19131 5.65 6.81733 7.40034 5.067C9.15067 3.31666 11.5246 2.33333 14 2.33333C16.4754 2.33333 18.8493 3.31666 20.5997 5.067C22.35 6.81733 23.3333 9.19131 23.3333 11.6667Z" stroke="#111827" stroke-width="1.8"/>
                            </svg>
                        </div>
                        <p>No:380, 3rd floor,Al Zamil Business Centre, 2nd Industrial City,New Sanaya, Riyadh -11373</p>
                    </div>
                    <div class="contact-info-card__grid">
                        <div class="contact-info-card__action">
                            <a href="tel:+966506916690" class="contact-info-card__value">+966 50 691 6690</a>
                            <a href="tel:+966506916690" class="contact-info-card__button">Call Us Now</a>
                        </div>
                        <div class="contact-info-card__action">
                            <a href="mailto:info@cariox.com" class="contact-info-card__value">info@cariox.com</a>
                            <a href="mailto:info@cariox.com" class="contact-info-card__button">Email Us</a>
                    ...
                    <div class="contact-info-card__footer">
                        <div class="contact-info-card__country">
                                <img src="public/images/flag/ksa.png" width="50" height="50" alt="Saudi Arabia">
                ...
                <div class="contact-info-card">
                    ...
                    <div class="contact-info-card__grid">
                        <div class="contact-info-card__action">
                            <a href="tel:+00256 708 885555" class="contact-info-card__value">00256 708 885555</a>
                            <a href="tel:+00256 708 885555" class="contact-info-card__button">Call Us Now</a>
                        </div>
                        <div class="contact-info-card__action">
                            <a href="mailto:info@cariox.com" class="contact-info-card__value">info@cariox.com</a>
                            <a href="mailto:info@cariox.com" class="contact-info-card__button">Email Us</a>
                    ...
                    <div class="contact-info-card__footer">
                        <div class="contact-info-card__country">
                                <img src="public/images/flag/uga.png" width="50" height="50" alt="Uganda">
                            <span>Uganda</span>
                        </div>
                        <div class="contact-info-card__links">
                            <a href="https://wa.me/+971545864310?text=Can%20I%20get%20more%20details%20about%20your%20service?" target="_blank" rel="noopener" class="contact-info-card__whatsapp">
