<footer class="footer-cariox">
        ...
        <div class="container-ctn">
            <div class="footer-cariox-grid">
                <div class="footer-cariox-about">
                    <picture>
                        <img src="public/images/logo.png" alt="Cariox Technologies" width="180" height="70"
                            class="img-fluid">
                    </picture>
                ...
                <div class="footer-cariox-links-wrapper d-flex flex-wrap">
                    ...
                    <div class="footer-cariox-contact">
                        ...
                        <div class="contact-line">
                            <img src="public/images/icons/ion_location-outline.png" width="16" height="16" alt="">
                            <p>Warehouse Number 7, Beside China Mall, Al Jurf, Ajman, UAE.</p>
                        </div>
                        <div class="contact-line">
                            <img src="public/images/icons/solar_phone-outline.png" width="16" height="16" alt="">
                            <a href="tel:+97167494981">+971 6 749 4981</a>
                        </div>
                        <div class="contact-line">
                            <img src="public/images/icons/iconoir_mail.png" width="16" height="16" alt="">
                            <a href="mailto:info@cariox.com">info@cariox.com</a>
                        </div>
                    </div>
                    <div class="footer-cariox-contact">
                        ...
                        <div class="contact-line">
                            <img src="public/images/icons/ion_location-outline.png" width="16" height="16" alt="">
                            <p>Astropack LLC KSA, Office No:380, 3rd floor, Al Zamil Business Centre, 2nd Industrial
                                City. New Sanaya, Riyadh -11373</p>
                        </div>
                        <div class="contact-line">
                            <img src="public/images/icons/solar_phone-outline.png" width="16" height="16" alt="">
                            <a href="tel:+966506916690">+966 50 691 6690</a>
                        </div>
                        <div class="contact-line">
                            <img src="public/images/icons/iconoir_mail.png" width="16" height="16" alt="">
                            <a href="mailto:info@cariox.com">info@cariox.com</a>
                    ...
                    <div class="footer-cariox-contact">
                        ...
                        <div class="contact-line">
                            <img src="public/images/icons/solar_phone-outline.png" width="16" height="16" alt="">
                            <a href="tel:00256708885555">00256 708 885555</a>
                        </div>
                        <div class="contact-line">
                            <img src="public/images/icons/iconoir_mail.png" width="16" height="16" alt="">
                            <a href="mailto:info@cariox.com">info@cariox.com</a>
                    ...
                    <div class="footer-cariox-social-newsletter w-100">
                        <ul class="footer-cariox-social" aria-label="Social media">
                            <li><a href="#" aria-label="Facebook"><img src="public/images/icons/fb.png" alt=""
                                        width="20" height="20"></a></li>
                            <li><a href="#" aria-label="Twitter"><img src="public/images/icons/twitter.png" alt=""
                                        width="20" height="20"></a></li>
                            <li><a href="#" aria-label="LinkedIn"><img src="public/images/icons/link.png" alt=""
                                        width="20" height="20"></a></li>
                            <li><a href="#" aria-label="Instagram"><img src="public/images/icons/instagram.png" alt=""
                                        width="20" height="20"></a></li>
                            <li><a href="#" aria-label="Pinterest"><img src="public/images/icons/pinterest.png" alt=""
                                        width="20" height="20"></a></li>
                            <li><a href="#" aria-label="YouTube"><img src="public/images/icons/yt.png" alt="" width="20"
                                        height="20"></a></li>
                        </ul>
                        <div class="footer-cariox-newsletter d-flex  align-items-center">
                            <label for="footer-email" class="m-0">Newsletter</label>
                            <form action="#" method="post" class="newsletter-form">
                                <input type="email" id="footer-email" placeholder="Enter email address" name="email"
                                    required>
    ...
    <div class="footer-cariox-copyright">
        <div class="container-ctn">
            <p>Copyright &copy; <?php echo date('Y'); ?> Cariox. All Rights Reserved Design by : <a
                    href="https://mightywarner.ae/" target="_blank" rel="noopener">Mighty Warners Technology</a></p>
...
<div class="offcanvas offcanvas-end mobile_left_menu" tabindex="-1" id="burgerMenu"
    ...
    <div class="offcanvas-header">
        ...
        <a href="index.php" aria-label="Website Logo">
            ...
            <picture>
                <img src="public/images/logo.png" alt="Cariox logo" width="180" height="70" loading="lazy"
            ...
            <ul>
                ...
                <li class="has-submenu">
                    <div class="menu-item-flex">
                        <a href="products.php" aria-label="Explore our products">Products</a>
                    ...
                    <ul class="mobile-sub-menu">
                        <li><a href="product-detail.php">Ink-Jet Printers</a></li>
                        <li><a href="product-detail.php">Marking & Coding</a></li>
                        <li><a href="product-detail.php">Inspection Systems</a></li>
                        <li><a href="product-detail.php">Packing Systems</a></li>
                        <li><a href="product-detail.php">Labelling Machines</a></li>
                        <li><a href="product-detail.php">Handheld Printers</a></li>
                        <li><a href="product-detail.php">Conveyors</a></li>
                        <li><a href="product-detail.php">Laser Systems</a></li>
                        <li><a href="product-detail.php">Consumables</a></li>
                        <li><a href="product-detail.php">Spares</a></li>
                    </ul>
                </li>
...
<div class="leftFixedBox" aria-label="Quick contact actions">
...
<script src="public/js/lib/jquery.fancybox.min.js" defer></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js" defer></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/ScrollTrigger.min.js" defer></script>
<!-- <script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js" defer></script> -->
<script src="public/js/lib/jquery.star-rating-svg.min.js" defer></script>
