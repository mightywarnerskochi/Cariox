...
<div class="inner-vector">
    <picture><img src="{{ asset('assets/images/inner/inner-vector.png') }}" alt="Terms & Conditions"></picture>
</div>
            ...
            <nav class="breadcrumb" aria-label="Breadcrumb">
                ...
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        ...
                        <path d="M14.625 2.25H3.375C3.07677 2.25045 2.79088 2.36912 2.58 2.58C2.36912 2.79088 2.25045 3.07677 2.25 3.375V14.625C2.25045 14.9232 2.36912 15.2091 2.58 15.42C2.79088 15.6309 3.07677 15.7496 3.375 15.75H14.625C14.9232 15.7496 15.2091 15.6309 15.42 15.42C15.6309 15.2091 15.7496 14.9232 15.75 14.625V3.375C15.7496 3.07677 15.6309 2.79088 15.42 2.58C15.2091 2.36912 14.625 2.25 14.625 2.25ZM10.125 3.375V5.625H7.875V3.375H10.125ZM3.375 14.625V3.375H6.75V6.75H11.25V3.375H14.625L14.6256 14.625H3.375Z" fill="#F04149"/>
                    </svg>
                    Terms & Conditions
                </span>
            </nav>
...
<section class="policy">
    <div  class="container-content features-list">
        <div class="container-ctn">
            {!! $siteSetting->terms_conditions ?? '<p>Please contact our support for our full Terms and Conditions.</p>' !!}
        </div>
    </div>
</section>
@endsection