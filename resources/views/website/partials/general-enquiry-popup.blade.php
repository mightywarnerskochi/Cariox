            ...
            <div class="modal-body p-0">
                <div class="modal-body-content">
                    <div class="modal-form">
                        ...
                        <form id="siteGeneralEnquiryFormValidation" action="{{ route('enquiry-submit') }}" method="post" enctype="multipart/form-data"
                            class="d-flex flex-wrap justify-content-between" novalidate>
                            @csrf
                            <input type="hidden" name="form_type" value="general">
                            <div class="formGroup col--6">
                                <input type="text" id="name_general" name="name" placeholder="Name" autocomplete="name"
                            ...
                            <div class="formGroup col--6">
                                <input type="email" id="email_general" name="email" placeholder="Email"
                            ...
                            <div class="formGroup col--6">
                                <input type="tel" id="phone_general" name="phone_number" class="phone_number "
                            ...
                            <div class="formGroup col--6">
                                <input type="text" id="company_general" name="company" placeholder="Company" 
                            ...
                            <div class="formGroup col-12">
                                <textarea id="message_general" name="message" placeholder="Message" rows="6"></textarea>
                            </div>
