        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 col-md-6 text-center text-md-end pe-md-5 mb-5 mb-md-0">
                <div class="graphic-404">
                    <img loading="lazy" src="{{ asset('assets/images/404.png') }}" alt="404" class="img-fluid" style="max-width: 320px;">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="content-404">
                    ...
                    <div class="action-buttons d-flex flex-wrap gap-3 mt-4">
                        ...
                        <a href="{{ url('contact') }}" class="btn btn-outline-custom">Contact Support</a>
                    </div>
                </div>
            </div>
        </div>
