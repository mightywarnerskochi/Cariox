                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1.5rem;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="display_in_home" class="form-control">
                            <option value="0" {{ old('display_in_home', $product->display_in_home) == 0 ? 'selected' : '' }}>No</option>
                            <option value="1" {{ old('display_in_home', $product->display_in_home) == 1 ? 'selected' : '' }}>Yes</option>
                        </select>
                    </div>
                </div>
