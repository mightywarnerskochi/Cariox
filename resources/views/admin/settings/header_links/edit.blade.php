...
<div class="dashboard-content">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <h2 style="font-size: 1.5rem; font-weight: 600; color: #1e293b; margin: 0;">Edit Header Link</h2>
    ...
    <div class="section-container">
        <div class="section-body">
            <form action="{{ route('admin.settings.header_links.update', $link->id) }}" method="POST">
                @csrf
                ...
                <div style="margin-top: 2rem; border-top: 1px solid #e2e8f0; padding-top: 1.5rem;">
                    <button type="submit" class="btn-update" style="padding: 0.75rem 2.5rem; background: #2563eb; color: white; border-color: #2563eb;">Update Link</button>
                    <a href="{{ route('admin.settings.header_links.index') }}" class="btn-update" style="padding: 0.75rem 2rem; text-decoration: none; border-color: #e2e8f0; color: #64748b; margin-left:1rem;">Cancel</a>
                </div>
            </form>
        </div>
    </div>
