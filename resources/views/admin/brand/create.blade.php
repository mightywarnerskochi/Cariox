...
<div class="dashboard-content">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
        <h2 style="font-size: 1.5rem; font-weight: 600; color: #1e293b; margin: 0;">Add Brand</h2>
        ...
        <div class="section-body">
            <form method="POST" action="{{ route('admin.brand.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="alt_text" class="form-control" placeholder="e.g. Brand Name" value="{{ old('alt_text') }}">
                </div>

                <div class="form-group">
                    <label>Position</label>
                    <input type="number" min="1" name="position" class="form-control" value="1" readonly>
                    <small style="color: #64748b;">New brands are automatically assigned to position 1.</small>
                </div>
                ...
                <div style="text-align: right; margin-top: 1.5rem;">
                    ...
                    <button type="submit" class="btn-add" style="padding: 0.55rem 1rem;">Save Brand</button>
                </div>
            </form>
        </div>
    </div>
